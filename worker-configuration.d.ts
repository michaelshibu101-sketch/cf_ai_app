/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 8e9b9f923efcfa9f43a306dcf3554b5b)
// Runtime types generated with workerd@1.20260317.1 2026-03-29 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "AiAppAgent";
	}
	interface Env {
		AI: Ai;
		ASSETS: Fetcher;
		AI_APP: DurableObjectNamespace<import("./src/index").AiAppAgent>;
		AI_APP_WORKFLOW: Workflow<Parameters<import("./src/index").AiPlanWorkflow['run']>[0]['payload']>;
	}
}
